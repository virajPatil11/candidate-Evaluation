...
//        workbook.close();
    ...
    public byte[] generateReportByEvaluator(List<Feedback> feedbacks, String empName) throws IOException {
     ...
     // Write headers
        Row headerRow = sheet.createRow(0);
        headerRow.createCell(0).setCellValue("Evaluator Id");
        headerRow.createCell(1).setCellValue("Evaluator Name");
        ...
        headerRow.createCell(3).setCellValue("Candidate Phone");
        headerRow.createCell(4).setCellValue("Candidate Email");
        headerRow.createCell(5).setCellValue("Feedback Screening Level");
        headerRow.createCell(6).setCellValue("Feedback Date");
        headerRow.createCell(7).setCellValue("Feedback status");
        ...
        // Write data
           ...
           for (Feedback feedback : feedbacks) {
               Row row = sheet.createRow(rowNum++);
               	row.createCell(0).setCellValue(feedback.getFeedbackEvalutorId());
	   			row.createCell(1).setCellValue(feedback.getFeedbackEvalutor().getEmpName());
	   			break;
           }
           int rowNum2 = 4;
           for (Feedback feedback : feedbacks) {
        	   Row row = sheet.createRow(rowNum2++);
	   			...
	   			row.createCell(3).setCellValue(feedback.getFeedbackCandidate().getCandidatePhone());
	   			row.createCell(4).setCellValue(feedback.getFeedbackCandidate().getCandidateEmail());
	   			row.createCell(5).setCellValue(feedback.getFeedbackScreeningLevel());
	   			row.createCell(6).setCellValue(feedback.getFeedbackDatetime());
	   			row.createCell(7).setCellValue(feedback.getFeedbackStatus());
           }
