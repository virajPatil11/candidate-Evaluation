	...
	<body>
		...
		<div class="container my-2">
			...
			<a class="btn btn-outline-primary"
				href="/candidateEvaluationApplication/candEvalApp/candidate/candidate-form">
				Add New Candidate
			</a>
			
			<!-- End Add New Candidate button -->
			
			<!-- Start of Candidate's list table -->
			
			<div class="row my-4" style="border: solid 1px #CCCCCC; ">
				...
				<h3 style="FONT-FAMILY: Arial; text-align: left;
					    ...
					    border: solid 0px #FFFFFF;">Candidate List</h3>
				...
				<div class="col">
					...
					<table class="table table-bordered" >
						...
						<core:forEach var="cl" items="${candList}">
							...
							<tr style=" empty-cells: show;
								    ...
								    padding-left: 4px;
								    width: 10%;">
								<td>${cl.candidateId}</td>
								<td>${cl.candidateName}</td>
								<td>${cl.candidatePhone}</td>
								<td>${cl.candidateEmail}</td>
							<td>
							
							<!-- Delete button start -->
								<a href="/candidateEvaluationApplication/candEvalApp/candidate/candidate-delete/${cl.candidateId}"
                  					class="btn btn-outline-danger m-2" id="openPopup"
							...
							<!-- Delete button close -->
								...
								<a href="/candidateEvaluationApplication/candEvalApp/candidate/candidate-update-form/${cl.candidateId}"
                  					class="btn btn-outline-warning m-2">
                  					<i class="bi bi-pencil-square"></i>
								</a>
								
								<a href="/candidateEvaluationApplication/candEvalApp/candidate/candidate-details/${cl.candidateId}"
