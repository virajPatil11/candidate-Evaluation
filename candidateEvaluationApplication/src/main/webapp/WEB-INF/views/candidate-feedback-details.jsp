	...
	<body>
		...
		<div class="row my-2" style="border: solid 1px #CCCCCC;">
			...
			<table class="table table-bordered m-2">
				...
				<tr>
					<th style="background-color: #CCCCCC;" colspan="2">Candidate Name</th>
					<td style="background-color: #F4F4F4;" colspan="4">${candidate.candidateName}</td>
				</tr>
				
				<tr>
					<th style="background-color: #CCCCCC;" colspan="2">Candidate Resume</th>
					...
					target="_blank" class="btn btn-outline-primary">View Resume</a>
						<a href="/candidateEvaluationApplication/candEvalApp/resources/resume/${candidate.candidateResume}" 
					class="btn btn-outline-primary bi bi-download" download> Download Resume</a>
					</td>
